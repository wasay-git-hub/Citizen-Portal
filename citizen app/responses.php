<?php
    ...
    $sql = "SELECT * FROM surveys ORDER BY survey_id ASC";
...
<div class="survey-grid">
  ...
  <div class="survey-id">Survey ID: <?php echo "${"retrieved_survey_id$i"}" ?></div>
    ...
    <form action="responses2.php" method="GET" style="margin-top: 10px;">
  ...
  <button class="answer-btn" type="submit" name="submit">Check Answers</button>
</form>
