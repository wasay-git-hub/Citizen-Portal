...
$sql = "SELECT * FROM idcard_applicants";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["allot_date"], $_POST["applicant_cnic"])) {
    ...
    $stmt = $conn->prepare("UPDATE idcard_applicants SET date_allotted = ?, status = 'Accepted' WHERE cnic = ?");
...
<head>
    ...
    <title>ID Card Application Records</title>
    ...
    <div class="container">
        <header>
            <div class="logo">
                ...
                <h1>CNIC Application Records</h1>
            </div>
        </header>
        ...
        <footer>
            <p>© <?php echo date("Y"); ?> CNIC Application System. All rights reserved.</p>
        </footer>
    </div>
</body>
</html>
