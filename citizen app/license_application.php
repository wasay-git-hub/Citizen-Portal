...
$sql = "SELECT fullname, fathername,cnic, date_of_birth, gender, mobile_number, permanent_address, status,date_allotted FROM license_applicants";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["allot_date"], $_POST["applicant_cnic"])) {
    ...
    $stmt = $conn->prepare("UPDATE license_applicants SET date_allotted = ?, status = 'Accepted' WHERE cnic = ?");
    ...
    <div class="container">
        <header>
            <div class="logo">
                ...
                <h1>License Application Records</h1>
            </div>
        </header>
        ...
        <div class="records-container">
            ...
            <?php else: ?>
                <div class="no-records">
                    ...
                    <p>No license application records found in the database.</p>
                </div>
            <?php endif; ?>
        </div>

        <footer>
            <p>© <?php echo date("Y"); ?> License Application System. All rights reserved.</p>
        </footer>
    </div>
</body>
</html>
