<?php
  ...
  $sql_for_retrieval = "SELECT * FROM idcard_applicants WHERE cnic = '$cnic_to_display'";
...
<head>
  <meta charset="UTF-8">
  <title>ID Card Appointments</title>
  <style>
    body {
      margin: 0;
...
<body>
  ...
  <h2>Appointments for ID Card</h2>
  <?php
  ...
  ?>
  <p id="xyz">You haven't applied for ID card.</p>
  <?php
    }
  ?>
</body>
