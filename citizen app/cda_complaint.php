...
$sql = "SELECT * FROM complaints WHERE department = 'CDA' ORDER BY date_of_complaint DESC";
...
<body>
<div class="police-banner">CDA COMPLAINTS</div>
    <div class="container">
                            ...
                            <td>
                                <div class="action-btns">
                                    <?php if($row['status'] != 'Resolved'): ?>
                                        <form method="post">
                                        <button class="action-btn resolve-btn" type="submit" name="resolve-btn">Resolve</button>
                                        </form>
                                    <?php 
