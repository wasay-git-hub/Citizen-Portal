...
<body>
  ...
  <div class="form-container">
    ...
    <form action="appointments6.php" method="post" enctype="multipart/form-data">
...
<?php
    if($_SERVER["REQUEST_METHOD"]=='POST'){
      ...
      try{
        if(eligible($dob)){
          $sql = "INSERT INTO idcard_applicants(fullname,fathername,cnic,date_of_birth,gender,mobile_number,
          ...
          echo "You are under 18, hence not eligible for a ID Card.";
        }
      }
      catch(mysqli_sql_exception){
        echo "Your application couldn't be processed. Maybe you have already applied!";
      }
